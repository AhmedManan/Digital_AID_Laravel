                                ...
                                <div class="card-body">
                                    ...
                                    <br/>
                                        <div>
                                            ...
                                            <button id="btn-Preview-Image" onClick="createQrCode()">Genarate Card</button>
                                            <a id="btn-Convert-Html2Image" href="">Download</a>
                                            <br/>
                                        </div>
                                        <div>
                                            <br>
                                            <div id="html-content-holder" style="visibility: hidden; background-color: #ffdaa260; color: #00cc65; width: 300px; padding-left: 25px; padding-top: 10px;">
                                                <strong>DIGITAL AID</strong><hr/>
                                                <h3 style="color: #3e4b51;">
                                                    <p>{{$user->username}}</p>
                                                    <img src="/img/user/profilepic/{{$user->person_photo}}.jpg" id="imgProfile" style="width: 150px; height: 150px" class="img-thumbnail" />
                                                </h3>
