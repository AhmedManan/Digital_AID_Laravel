    ...
    public function users(Request $req,$name=""){
     ...
     public function validnow(Request $req,$usernameprofile){
            ...
            ->first();
             ...
             // ->where('login_creds.usertype','=','consumer')
            //  ->where('login_creds.status','=','invalid')
             ->where('login_creds.username','=',$usernameprofile)
             ->select('login_creds.id','login_creds.email', 'login_creds.usertype', 'user_infos.username', 'user_infos.first_name', 'user_infos.last_name', 'login_creds.usertype', 'user_infos.person_photo', 'user_infos.joindate', 'user_infos.joindate', 'user_infos.division', 'user_infos.zilla',  'user_infos.upzilla', 'user_infos.union', 'user_infos.ward', 'user_infos.house' )
             ->first();
            // $user->status="valid";
            // $user->save();
            ...
            return view('admin.admincardscan') ->with('dashboard',$dashboard)
                                            ...
                                            ->with('unverifieduser',$unverifiedusers);
     }
     ...
     public function cardscanPost(Request $req){
        ...
        return redirect('/admin/unverifiedusers');
