...
--
-- Host: 127.0.0.1
-- Generation Time: May 07, 2021 at 12:58 PM
...
(4, '', 'consumer', 'for raf 2', '2020-10-14', 'none,omer,raf'),
(5, 'mnn', 'consumer', 'dddss', '2020-10-28', 'none,raf,omer'),
(6, 'mnn', 'consumer', 'cons', '2020-10-28', 'none,omer'),
(7, 'mnn', 'consumer', 'cons two', '2020-10-28', 'none,raf,omer'),
(8, 'mnn', 'consumer', 'gjgjgjgjg', '2020-11-11', 'none,omer,raf'),
(9, 'mnn', 'distributor', 'gjgjgjgjg', '2020-11-11', 'none,omer'),
(10, 'mnn', 'all', 'knkln.lmjl;', '2020-11-11', 'none,raf,raf,raf'),
(11, 'mnn', 'distributor', 'gtrfmghhjhgjy', '2020-11-11', 'none,omer'),
(12, 'mnn', 'consumer', 'my name is admin', '2020-11-29', 'none,raf'),
(13, 'mnn', 'consumer', 'my name is admin 2', '2020-11-29', 'none,raf'),
(14, 'mnn', 'consumer', 'my name is admin 3', '2020-11-29', 'none,raf,raf'),
(15, 'mnn', 'consumer', 'my name is admin 4', '2020-11-29', 'none,raf'),
(16, 'mnn', 'all', 'my name is admin 5', '2020-11-29', 'none,raf'),
(17, 'mnn', 'all', 'my name is admin 6', '2020-11-29', 'none'),
(18, 'mnn', 'consumer', 'my name is admin 4', '2020-11-29', 'none,raf'),
(19, 'mnn', 'consumer', 'my name is admin 5', '2020-11-29', 'none,raf,raf,raf'),
(20, 'mnn', 'consumer', 'my name is admin 6', '2020-11-29', 'none,raf'),
(21, 'mnn', 'consumer', 'My name is admin 7', '2020-11-29', 'none,raf'),
(22, 'mnn', 'consumer', 'my name is admin 8', '2020-11-29', 'none,raf'),
(23, 'mnn', 'consumer', 'my name is admin 9', '2020-11-29', 'none,raf'),
(24, 'mnn', 'all', 'hkhkhk', '2020-12-25', 'none'),
(25, 'mnn', 'all', 'khlkhl', '2020-12-25', 'none'),
(26, 'mnn', 'consumer', 'jhikhlk', '2020-12-25', 'none,raf'),
(27, 'mnn', 'consumer', 'bhjgjk', '2020-12-25', 'none,raf,raf'),
(28, 'mnn', 'distributor', 'khlkhl', '2020-12-26', 'none,omer');
...
(2, 'safrin@gmail.com', 'safrin', '12345', 'admin', 'valid'),
...
INSERT INTO `notifications` (`id`, `sender`, `receiver`, `description`, `date`) VALUES
(5, 'mnn', 'safrin', 'changed your information', '2020-11-17'),
(6, 'mnn', 'omer', 'changed your information', '2020-11-18');
...
CREATE TABLE `user_infos` (
  ...
  `upzilla` varchar(30) DEFAULT NULL,
  `union` varchar(30) DEFAULT NULL,
...
INSERT INTO `user_infos` (`id`, `username`, `first_name`, `last_name`, `email`, `phone`, `nid_no`, `nid_photo`, `person_photo`, `gender`, `birthdate`, `joindate`, `qr_code`, `division`, `zilla`, `upzilla`, `union`, `ward`, `house`) VALUES
(1, 'mnn', 'Ahmed', 'Manan', 'ahmed.mnn@gmail.com', '2020-08-03', '8865965420', '8865965477', 'mnn', 'male', '1996-06-30', '2020-08-03', '97hf8769jfri4nmm3kitnh4ngfj7hg', 'BARISAL', 'BARISAL', 'BAKERGONJ', 'KALASKATI', '17', 'KATPOTTI ROAD'),
(2, 'safrin', 'saf', 'rin', 'safrin@gmail.com', '01236547', '00123654', '00123654', 'safrin', 'female', '2020-08-02', '2020-08-04', '97hf8769jfri4nhg3kitnh4ngfj7hg', NULL, NULL, NULL, NULL, NULL, NULL),
(3, 'omer', 'Omer', 'Fahim', 'fahim@outlook.com', '2020-09-14', '88691', '8873649765', '6576407768', 'male', '2020-09-15', '2020-09-14', '97hf8769jfri4nhg3kitgh4ngfj7hg', NULL, NULL, NULL, NULL, NULL, NULL),
(4, 'raf', 'Al', 'Arraf', 'raf@gmail.com', '2020-09-14', '8869376486', '8873649765', 'raf', 'male', '2020-09-15', '2020-09-14', 'iqEHhl0msdLWCBb8sRKApHbsbMLywW', NULL, NULL, NULL, NULL, NULL, NULL);
