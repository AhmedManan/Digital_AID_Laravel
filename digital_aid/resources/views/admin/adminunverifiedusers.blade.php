			...
			<div class="main-panel">
				<div class="content">
					<div class="container-fluid">
						...
						<h4 class="page-title">Unverified Users</h4>
...
<table class="table tablemanager table-bordered">
		...
		<tbody>
		@foreach($unverifiedusers as $result)
			<tr>
				<td class="prova">
                ...
                <td class="prova">{{ $result->usertype  }}</td>
				<td class="prova">
				<a class="btn btn-default la la-info" href="/admin/viewprofile/{{$result->username}}"> Details</a>
				<!-- @if($result->username!=$user->username)
				<a class="btn btn-default la la-envelope" href="/admin/inbox/{{$result->username}}"> Message</a>
				@endif -->
                <a class="btn btn-success la la-user-plus" href="/admin/validnow/{{$result->username}}"> Valid Now</a>
				</td>
			</tr>
			@endforeach
		</tbody>
