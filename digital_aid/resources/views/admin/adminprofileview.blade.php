				...
				<div class="content">
					<div class="container-fluid cta-inner text-center rounded">
                        ...
                        <div class="w3-bar w3-black ">
                            ...
                            <button class="btn-primary btn-lg active" onclick="openTab('admin')">Admin Options</button>
                            @endif
                            @if($userinfoprofile->username==session('sessionusername'))
                          ...
                          <div id="view" class="w3-container city">
                            @include('admin/viewprofile/viewprofile')
                          </div>
                          
                          <div id="edit" class="w3-container city" style="display:none">
                            @include('admin/viewprofile/editprofile')
                          </div>
                          
                          <div id="admin" class="w3-container city" style="display:none">
                          @include('admin/viewprofile/changeinfo')
                          </div>
