				...
				<div class="container-fluid">
					...
					<li class="nav-item dropdown hidden-caret">
							...
							<ul class="dropdown-menu notif-box" aria-labelledby="navbarDropdown">
								...
								@else
									<div class="dropdown-title">You have no new message</div>
								@endif
								</li>
								<li>
						...
						<li class="nav-item dropdown hidden-caret">
							...
							<ul class="dropdown-menu notif-box" aria-labelledby="navbarDropdown">
								...
								@else
									<div class="dropdown-title">You have no Pending Task</div>
								@endif
								</li>
								<li>
									<div class="notif-center">
				...
				<div class="scrollbar-inner sidebar-wrapper">
					...
					<ul class="nav">
						...
						<div class="collapse in" id="users" aria-expanded="true" style="">
							<li class="nav-item">
								<a class="nav-item" href="/admin/adminslist">
									<span class="link-collapse"> Admin List</span>
								</a>
							</li>
							<li class="nav-item">
								<a href="/admin/distributorslist">
									<span class="link-collapse">Distributor List</span>
								</a>
							</li>
							<li class="nav-item">
								<a href="/admin/consumerslist">
									<span class="link-collapse">Consumer List</span>
								</a>
							</li>
							<li class="nav-item">
								<a href="/admin/unverifiedusers">
