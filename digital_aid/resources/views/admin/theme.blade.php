			...
			<div class="main-panel">
				<div class="content">
					<div class="container-fluid cta-inner text-center rounded">
						...
						<p><strong>NavBar & Sidebar</strong></p>
						<div class="btn-group-justified">
						  <a href="/theme/1" class="btn btn-muted btn-lg btn-round">White</a>
						  <a  href="/theme/6"  class="btn btn-warning btn-lg btn-round">Yellow</a>
						  <a href="/theme/2"  class="button3 btn-lg btn-round">Coffiee</a>
						  <a  href="/theme/3"  class="button2 btn-lg btn-round">Skyblue</a>
						  <a  href="/theme/4"  class="button4 btn-lg btn-round">Gradient 1</a>
						  <a  href="/theme/5"  class="button5 btn-lg btn-round">Gradient 2</a>
						</div>
						<style>
						.button2 {background-color: #87CEEB; color: rgb(0, 0, 0);} /* Blue */
						.button3 {background-color:rgba(47, 23, 15, 0.9); color: rgb(255, 255, 255);} /* Gray */ 
						.button4 {background-color: #D9AFD9; background-image: linear-gradient(0deg, #D9AFD9 0%, #97D9E1 100%); color: rgb(0, 0, 0);}
						.button5 {background-color: #7f5a83; background-image: linear-gradient(315deg, #7f5a83 0%, #0d324d 74%); color: rgb(255, 255, 255);} /* Black */
						</style>
