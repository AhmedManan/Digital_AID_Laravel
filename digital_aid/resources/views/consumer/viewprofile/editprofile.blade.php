                                        ...
                                        <div class="card-title mb-4">
                                            <div class="d-flex justify-content-start">
                                                ...
                                                <form method="post" enctype="multipart/form-data" action="/consumer/updatepicture">
									...
									<div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 col-6">
                                                ...
                                                @include('consumer/viewprofile/changepass-modal')
                                            </div>
                                        </div>
                                        <hr>
										...
										<div class="row">
                                            ...
                                            <div class="col-md-8 col-6">
									<img src="/img/user/nidpic/{{$userinfoprofile->nid_photo}}.jpg" id="imgProfile" style="max-width: 350px; height: 150px" class="img-thumbnail" />
								...
								<input type="file" class="btn btn-info btn-sm" name="file" class="form-control-file">
										...
										<div class="row">
                                            ...
                                            <div class="col-md-8 col-6">
                                                ...
                                                @include('consumer/viewprofile/currentpass-modal')
                                            </div>
                                        </div>
                                    </form>
